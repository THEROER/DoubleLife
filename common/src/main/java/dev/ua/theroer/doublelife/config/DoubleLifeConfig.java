...
public class DoubleLifeConfig {
    ...
    @ConfigSection("second-life")
    @Comment("Second-inventory behaviour: mode and which state belongs to the second life")
    private SecondLifeSettings secondLife = new SecondLifeSettings();
    ...
    public DoubleLifeConfig() {
        ...
        if (secondLife == null) {
            secondLife = new SecondLifeSettings();
        }
    }
