...
public class InventoryStorage {
    ...
    public InventoryStorage(DoubleLifePlugin plugin, String storagePath, ItemSerialization items) {
    ...
    public void saveSession(DoubleLifeSession session) {
        ...
        try {
            ...
            data.savedInventory = items.serializeInventory(session.getSavedInventory());
            data.savedArmor = items.serializeInventory(session.getSavedArmor());
            data.savedEnderChest = items.serializeInventory(session.getSavedEnderChest());
    ...
    public DoubleLifeSession loadSession(UUID playerUuid) {
        ...
        try {
            ...
            session.setSavedInventory(items.deserializeInventory(data.savedInventory));
            session.setSavedArmor(items.deserializeInventory(data.savedArmor));
            session.setSavedEnderChest(items.deserializeInventory(data.savedEnderChest));
